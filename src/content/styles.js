...
export const DEFERRED_STYLES = COMPONENTS_CSS + HERRINGTON_MEDICAL_CSS + ENHANCEMENTS_CSS + HEADER_CSS;

// Full CSS for legacy support with accessibility enhancements
export const CSS = CORE_CSS + COMPONENTS_CSS + HERRINGTON_MEDICAL_CSS + ENHANCEMENTS_CSS + A11Y_CSS + HEADER_CSS + PerformanceOptimizer.generateSkeletonCSS();
